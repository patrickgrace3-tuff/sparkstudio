...
const styles = {
  ...
  tab:             { padding: '12px 14px', fontSize: 13, color: 'var(--color-text-secondary)', background: 'none', border: 'none', borderBottomWidth: 2, borderBottomStyle: 'solid', borderBottomColor: 'transparent', marginBottom: -1, cursor: 'pointer' },
  tabActive:       { color: 'var(--color-text-primary)', borderBottomColor: 'var(--color-text-primary)', fontWeight: 500 },
  ...
  subTab:          { background: 'none', border: '0.5px solid transparent', borderRadius: 6, padding: '4px 12px', fontSize: 12, color: 'var(--color-text-secondary)', cursor: 'pointer' },
  subTabActive:    { background: 'var(--color-bg-secondary)', border: '0.5px solid var(--color-border)', color: 'var(--color-text-primary)', fontWeight: 500 },
  ...
  onlineDot:       { display: 'inline-block', width: 6, height: 6, borderRadius: '50%', background: '#22c55e', marginRight: 6, verticalAlign: 'middle' },
  deckReady:       { marginLeft: 'auto', color: '#22c55e', fontWeight: 500 },
  ...
  globalTitle:     { fontSize: 15, fontWeight: 600, color: 'var(--color-text-primary)' },
  globalSub:       { fontSize: 12, color: 'var(--color-text-muted)', flex: 1 },
  globalClose:     { background: 'none', border: '0.5px solid var(--color-border)', borderRadius: 6, padding: '5px 12px', fontSize: 12, cursor: 'pointer', color: 'var(--color-text-secondary)', flexShrink: 0 },
}