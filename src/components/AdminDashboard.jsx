...
const S = {
  ...
  tabBtn:        { background: 'none', border: 'none', borderBottom: '2px solid transparent', padding: '11px 16px', fontSize: 13, fontWeight: 400, color: 'var(--color-text-secondary)', cursor: 'pointer', marginBottom: -1 },
  tabBtnActive:  { color: 'var(--color-accent)', borderBottom: '2px solid var(--color-accent)', fontWeight: 600 },
