...
const styles = {
  ...
  item:           { display: 'flex', alignItems: 'center', borderRadius: 'var(--radius-sm)', border: '0.5px solid transparent', transition: 'border 0.1s' },
  itemMain:       { flex: 1, display: 'flex', alignItems: 'center', gap: 8, background: 'none', border: 'none', padding: '7px 8px', borderRadius: 'var(--radius-sm)', cursor: 'pointer', textAlign: 'left' },
  ...
  backBtn:        { background: 'none', border: '0.5px solid var(--color-border)', borderRadius: 'var(--radius-pill)', padding: '5px 12px', fontSize: 12, cursor: 'pointer', color: 'var(--color-text-secondary)', whiteSpace: 'nowrap' },
  fileNameInput:  { flex: 1, background: 'none', border: 'none', fontSize: 14, fontWeight: 500, color: 'var(--color-text-primary)', outline: 'none' },
  fileTypeBadge:  { fontSize: 11, color: 'var(--color-text-muted)', background: 'var(--color-bg-tertiary)', border: '0.5px solid var(--color-border)', padding: '2px 8px', borderRadius: 'var(--radius-pill)', flexShrink: 0 },
