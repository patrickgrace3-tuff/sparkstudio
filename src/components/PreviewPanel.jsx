...
const S = {
  ...
  presentBtn:     { background: 'transparent', color: 'var(--color-text-secondary)', border: '0.5px solid var(--color-border)', borderRadius: 7, padding: '8px 16px', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
  exportBtn:      { background: '#CD2F37', color: '#fff', border: 'none', borderRadius: 7, padding: '8px 16px', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
  ...
  slideTile:      { width: '100%', aspectRatio: '16 / 9', borderRadius: 6, overflow: 'hidden', border: '0.5px solid var(--color-border)' },
  ...
  presenterClose:   { position: 'fixed', top: 20, right: 24, background: 'transparent', color: '#fff', border: '0.5px solid rgba(255,255,255,0.3)', borderRadius: 7, padding: '6px 14px', fontSize: 13, cursor: 'pointer' },
