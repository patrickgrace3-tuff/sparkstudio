...
const styles = {
  ...
  headerLabel: { fontSize: 11, fontWeight: 600, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.07em' },
  ...
  deptItem: { display: 'flex', alignItems: 'center', gap: 9, padding: '9px 8px', borderRadius: 6, border: '0.5px solid transparent', background: 'none', color: 'var(--color-text-primary)', width: '100%', textAlign: 'left', cursor: 'pointer' },
  deptItemActive: { background: 'var(--color-bg)', border: '0.5px solid var(--color-border)' },
  dot: { width: 8, height: 8, borderRadius: '50%', flexShrink: 0 },
  deptName: { fontSize: 14, flex: 1 },
  badge: { fontSize: 11, color: 'var(--color-text-muted)', background: 'var(--color-bg-tertiary)', border: '0.5px solid var(--color-border)', padding: '1px 7px', borderRadius: 99 },
  ...
  generateBtn: { width: '100%', padding: '10px 0', borderRadius: 8, border: 'none', background: 'var(--color-text-primary)', color: 'var(--color-bg)', fontSize: 14, fontWeight: 500 },
  globalBtn:   { display: 'flex', alignItems: 'center', gap: 8, margin: '4px 6px 0', padding: '9px 8px', borderRadius: 6, border: '0.5px solid var(--color-border)', background: 'var(--color-bg)', cursor: 'pointer', width: 'calc(100% - 12px)', textAlign: 'left' },
