...
const styles = {
  ...
  suggestion:     { background: 'var(--color-bg-secondary)', border: '0.5px solid var(--color-border)', borderRadius: 7, padding: '8px 12px', fontSize: 12, color: 'var(--color-text-secondary)', cursor: 'pointer', textAlign: 'left', lineHeight: 1.4 },
  userBubbleWrap: { display: 'flex', justifyContent: 'flex-end' },
  aiBubbleWrap:   { display: 'flex', justifyContent: 'flex-start' },
  userBubble:     { background: 'var(--color-text-primary)', color: 'var(--color-bg)', borderRadius: '10px 10px 2px 10px', padding: '8px 12px', fontSize: 13, maxWidth: '85%', lineHeight: 1.5 },
  aiBubble:       { display: 'flex', flexDirection: 'column', gap: 8, maxWidth: '95%' },
  aiText:         { fontSize: 13, color: 'var(--color-text-primary)', lineHeight: 1.6, background: 'var(--color-bg-secondary)', borderRadius: '10px 10px 10px 2px', padding: '8px 12px', margin: 0 },
  slideCard:      { background: 'var(--color-bg)', border: '0.5px solid var(--color-border)', borderRadius: 8, padding: '10px 12px', display: 'flex', flexDirection: 'column', gap: 6 },
  ...
  typing:         { display: 'flex', gap: 4, padding: '10px 14px', background: 'var(--color-bg-secondary)', borderRadius: '10px 10px 10px 2px', width: 48 },
  ...
  textarea:       { flex: 1, background: 'var(--color-bg-secondary)', border: '0.5px solid var(--color-border)', borderRadius: 8, padding: '8px 10px', fontSize: 13, color: 'var(--color-text-primary)', resize: 'none', outline: 'none', fontFamily: 'inherit', lineHeight: 1.5 },
  sendBtn:        { background: 'var(--color-text-primary)', color: 'var(--color-bg)', border: 'none', borderRadius: 7, padding: '8px 16px', fontSize: 13, fontWeight: 500, cursor: 'pointer', flexShrink: 0 },
}